================================================================================
    MICROSOFT FOUNDATION CLASS-BIBLIOTHEK: SMTP Tool-Projektübersicht
===============================================================================

Der Anwendungs-Assistent hat diese SMTP Tool-Anwendung für Sie 
...
finden, aus denen Ihre SMTP Tool–Anwendung besteht.
...
SMTP Tool.h
    ...
    die CSMTPToolApp-Anwendungsklasse.

SMTP Tool.cpp
    Dies ist die Hauptquelldatei der Anwendung, die die CSMTPToolApp-
...
res\SMTP Tool.ico
    ...
    Dieses Symbol ist in der Hauptressourcendatei "SMTP Tool.rc" 
    enthalten.
...
SMTP ToolDlg.h, SMTP ToolDlg.cpp – das Dialogfeld
    Diese Dateien enthalten Ihre CSMTPToolDlg–Klasse. Diese Klasse 
    bestimmt das Verhalten des Hauptdialogfelds Ihrer Anwendung. Die Vorlage des 
    Dialogfelds befindet sich in der Datei "SMTP Tool.rc", die in 
...
"StdAfx.h", "StdAfx.cpp"
    ...
    (PCH-Datei) mit dem Namen "SMTP Tool.pch.pch2 und eine 
